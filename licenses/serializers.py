...
class LicenseRenewalSerializer(serializers.Serializer):
    ...
    reason = serializers.CharField(
        max_length=500, required=False, help_text="Reason for renewal"
    )
...
class LicenseSuspensionSerializer(serializers.Serializer):
    ...
    reason = serializers.CharField(max_length=500, help_text="Reason for suspension")


class LicenseCancellationSerializer(serializers.Serializer):
    """Serializer for license cancellation requests."""

    reason = serializers.CharField(max_length=500, help_text="Reason for cancellation")
...
class ActivationDeactivationSerializer(serializers.Serializer):
    ...
    reason = serializers.CharField(
        max_length=500, required=False, help_text="Reason for deactivation"
    )
...
class LicenseActivationSerializer(serializers.Serializer):
    ...
    instance_type = serializers.CharField(
        max_length=100, required=False, default="website"
    )
