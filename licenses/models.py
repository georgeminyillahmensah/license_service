...
class Brand(models.Model):
    ...
    slug = models.SlugField(
        max_length=100, unique=True, help_text=_("URL-friendly brand identifier")
    )

    description = models.TextField(blank=True, help_text=_("Brand description"))

    is_active = models.BooleanField(
        default=True, help_text=_("Whether this brand is active in the system")
    )
...
class Product(models.Model):
    ...
    slug = models.SlugField(
        max_length=100, help_text=_("URL-friendly product identifier")
    )
    ...
    is_active = models.BooleanField(
        default=True, help_text=_("Whether this product is active")
    )
...
class LicenseKey(models.Model):
    ...
    customer_email = models.EmailField(help_text=_("Customer email address"))
    ...
    is_active = models.BooleanField(
        default=True, help_text=_("Whether this license key is active")
    )
...
class License(models.Model):
    ...
    expiration_date = models.DateTimeField(help_text=_("When this license expires"))

    # Lifecycle management fields
    original_expiration_date = models.DateTimeField(
        null=True, blank=True, help_text=_("Original expiration date before renewal")
    )

    renewal_count = models.PositiveIntegerField(
        default=0, help_text=_("Number of times this license has been renewed")
    )

    suspension_reason = models.TextField(
        blank=True, help_text=_("Reason for suspension if applicable")
    )

    cancellation_reason = models.TextField(
        blank=True, help_text=_("Reason for cancellation if applicable")
    )

    cancelled_at = models.DateTimeField(
        null=True, blank=True, help_text=_("When the license was cancelled")
    )

    suspended_at = models.DateTimeField(
        null=True, blank=True, help_text=_("When the license was suspended")
    )
...
class Activation(models.Model):
    ...
    is_active = models.BooleanField(
        default=True, help_text=_("Whether this activation is currently active")
    )

    activated_at = models.DateTimeField(auto_now_add=True)
    deactivated_at = models.DateTimeField(null=True, blank=True)
    deactivation_reason = models.TextField(
        blank=True, help_text=_("Reason for deactivation if applicable")
    )
    updated_at = models.DateTimeField(auto_now=True)
